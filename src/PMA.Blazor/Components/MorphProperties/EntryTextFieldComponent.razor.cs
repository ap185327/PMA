// <copyright file="EntryTextFieldComponent.razor" company="Andrey Pospelov">
...
{
    public partial class EntryTextFieldComponent : IDisposable
    {
        #region Injections
        ...
        private string TextValue
        {
            ...
            set
            {
                ...
                ViewModel.Entry = _textValue;
            }
        }

        private string Label => Resources.Strings.ResourceManager.GetString("EntryTextFieldComponent.Label");

        private string HelperText => string.Format(Resources.Strings.ResourceManager.GetString("EntryTextFieldComponent.HelperText")!, ViewModel.EntryId);
        ...
        {
            ViewModel.GetEntryIdCommand.Execute(null);
        }
